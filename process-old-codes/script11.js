    ...
    function drawCompetitions(d){
            ...
            if (type=="date1"){
                ...
                swimmerDispatch2.on("selectswimmer", function(swimmer,i) {
                    if (swimmer == "All") {
                        ...
                        left = scaleX2Time(swimsSwimmer[0].date);
                        console.log(left)
                        ...
                        tooltip.select("#swimmer3").html(swimsSwimmer[0].name);
                        tooltip.select("#country3").html(swimsSwimmer[0].country);
        ...
        function drawEvents (d){
            ...
            var radius = 1024/5,
                ...
                scaleRCircles = d3.scaleSqrt().range([(radius/3), 4*radius]).domain(speedExtent),
