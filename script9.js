...
function draw1 (err, rows, types, swimmers) {
    ...
    function showSpeedViz(){
        ...
        function drawCompetitions(d){
            ...
            expl.append('g').attr("transform","translate("+(margin2.l)+","+ (margin2.t)+")").attr('class','explCompetitions competitions');

            startExpl = expl.select(".explCompetitions");
            startExpl
                .append("circle")
                .attr("class","expl1")
                .attr("r",0)
            ...
            plotMiniMenu.append('g').attr("transform","translate("+(margin2.l)+","+ (margin2.t+100)+")").attr('class','axis axis-x axis-xCompetitions');
            ...
            sketchingRecords
                ...
                .on("click",function(d){
                    ...
                    $("html, body").animate({
                        scrollTop: ($("#speedPlot").offset().top)
                    }, 500);
